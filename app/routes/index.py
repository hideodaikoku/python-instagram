...
def blacknwhite():
    ...
    print os.path.abspath(os.path.join("app/images/", bw))
    pil.convertb(os.path.abspath(os.path.join("app/images/", bw)))
    return jsonify(result='Black and White')

@app.route('/p')
def posterize():
    bw = request.args.get('p', 0)
    print os.path.abspath(os.path.join("app/images/", bw))
    pil.convertp(os.path.abspath(os.path.join("app/images/", bw)))
    return jsonify(result='Posterize')
